        ...
        var Selection = function() {
            ...
            if (options.drawBorders) {
                borders = {
                   ...
                   top: insertBorder("hline").css("top", px(-1)),
    ...
    $.fn.zyPopup = function(options, param) {
        ...
        return this.each(function() {
            ...
            this.openPopup = function() {
                ...
                image.load( para.src, {}, render).attr("src", para.src);
...
var ZYFILE = {
    ...
    funUploadFile: function(file) {
        ...
        xhr.setRequestHeader('Access-Token', '12875');
        xhr.send(formdata)
    },
    ...
    $.fn.zyUpload = function(options, param) {
        ...
        return this.each(function() {
            ...
            this.addEvent = function() {
                    $(".upload_preview").height(para.previewheight);
                    $(".upload_preview").css("overflow","auto"); 
